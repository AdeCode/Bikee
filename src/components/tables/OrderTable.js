...
export default function OrderTable({rowData}) {
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">{row.no_of_items}</TableCell>
                      <TableCell align="left">{helperFunction.nairaFormat(row.total_amount)}</TableCell>
                      {/* <TableCell align="left" sx={{color:`${row.status === 'successful' ? 'green' : row.status === 'pending' ? '#CCCC00' : 'red'}`}}>{row.status}</TableCell> */}
                      <TableCell align="left"><Moment date={row.created_at}/></TableCell>
