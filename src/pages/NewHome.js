    ...
    <Container>
      ...
      <div className='flex lg:flex-col bg-red px-10 py-5'>
            <div className='flex flex-col justify-center items-center text-white mb-14'>
                <h1 className='text-[3rem] font-semibold mb-4'>It's a great day for a ride.</h1>
                <p className='text-base'>At the heart of a Bikee is your road companion. </p>
                <p className='text-base lg:mb-5'>Connected to you and any path you take.</p>
